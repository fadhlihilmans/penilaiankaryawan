...
<section class="section">
    <div class="section-header">
        ...
        <h1>{{ $formAdd ? 'Tambah Detail Evaluasi' : 'Edit Detail Evaluasi' }}</h1>
    </div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header"><h4>Form Detail Evaluasi</h4></div>
                    <div class="card-body">
                        <!-- Nama -->
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Detail Evaluasi</label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus Detail Evaluasi ini?</p>
            </div>
